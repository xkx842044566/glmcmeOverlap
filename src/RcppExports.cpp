...
RcppExport SEXP _glmcmeOverlap_mcp(SEXP betaSEXP, SEXP lambdaSEXP, SEXP gammaSEXP) {
BEGIN_RCPP
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(cme_wls(XX, yy, family, K1, lambda_vec, gamma_vec, tau_vec, XX_sl, beta_vec, act_vec, multiplier, lambda_max, it_max, it_warm, reset, screen_ind));
    return rcpp_result_gen;
END_RCPP
}
// cme_gaussian
List cme_gaussian(NumericMatrix& XX, NumericVector& yy, NumericVector& K1, NumericVector& lambda_vec, NumericVector& gamma_vec, NumericVector& tau_vec, NumericVector& XX_sl, NumericVector& beta_vec, NumericVector& act_vec, NumericVector& multiplier, double lambda_max, int it_max, int it_warm, int reset, bool screen_ind);
RcppExport SEXP _glmcmeOverlap_cme_gaussian(SEXP XXSEXP, SEXP yySEXP, SEXP K1SEXP, SEXP lambda_vecSEXP, SEXP gamma_vecSEXP, SEXP tau_vecSEXP, SEXP XX_slSEXP, SEXP beta_vecSEXP, SEXP act_vecSEXP, SEXP multiplierSEXP, SEXP lambda_maxSEXP, SEXP it_maxSEXP, SEXP it_warmSEXP, SEXP resetSEXP, SEXP screen_indSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix& >::type XX(XXSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type reset(resetSEXP);
    Rcpp::traits::input_parameter< bool >::type screen_ind(screen_indSEXP);
    rcpp_result_gen = Rcpp::wrap(cme_gaussian(XX, yy, K1, lambda_vec, gamma_vec, tau_vec, XX_sl, beta_vec, act_vec, multiplier, lambda_max, it_max, it_warm, reset, screen_ind));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_glmcmeOverlap_mcp", (DL_FUNC) &_glmcmeOverlap_mcp, 3},
    {"_glmcmeOverlap_cme_wls", (DL_FUNC) &_glmcmeOverlap_cme_wls, 16},
    {"_glmcmeOverlap_cme_gaussian", (DL_FUNC) &_glmcmeOverlap_cme_gaussian, 15},
    {NULL, NULL, 0}
};

RcppExport void R_init_glmcmeOverlap(DllInfo *dll) {
